...
> 🔍 **결과** > _single asterisks_ > _single underscores_ > **double asterisks** > **double underscores** > ~~cancelline~~
...
![그림1](/assets/img/blog/dark-mode.jpg)

![그림2](/assets/img/blog/dark-mode.jpg){: width="400" height="400"}
...
{% include components/youtubePlayer.html id="xg79mkbNaTg" %}
